 ...
 * implements the following specification: http://justpaste.it/MSAapk
 *
...
public class ProtocolWriter extends Writer {
  ...
  public void flush() throws IOException {
    ...
    long crc = crc(dataBytes);

    buffer.put(Protocol.OFFSET_TOKEN, Protocol.TOKEN);
    buffer.put(Protocol.OFFSET_DATA_TYPE, (byte) dataType.value);
    buffer.putShort(Protocol.OFFSET_DATA_LENGTH, (short) dataBytes.length);
    buffer.putInt(Protocol.OFFSET_CRC, (int) crc);
